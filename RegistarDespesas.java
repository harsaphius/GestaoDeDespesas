...
public class RegistarDespesas extends javax.swing.JInternalFrame {
    ...
    public RegistarDespesas() {
        initComponents();
        //cb_CategoriasDespesas = new javax.swing.JComboBox<>(recebe);
    ...
    private void initComponents() {
        ...
        txt_nporta = new javax.swing.JTextField();
        ...
        txt_NIF.addKeyListener(new java.awt.event.KeyAdapter() {
        ...
        txt_nporta.addCaretListener(new javax.swing.event.CaretListener() {
            public void caretUpdate(javax.swing.event.CaretEvent evt) {
                txt_nportaCaretUpdate(evt);
            }
        });
        txt_nporta.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                txt_nportaFocusLost(evt);
            }
        });
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(txt_data, javax.swing.GroupLayout.DEFAULT_SIZE, 177, Short.MAX_VALUE))
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(txt_nporta, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabel10)
                    .addComponent(txt_nporta, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel9)
    ...
    private void btn_InserirDespesaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_InserirDespesaActionPerformed
        ...
        String tpSelected = (String) cb_paymentType.getSelectedItem();
        int tpId = createdesp.getTipoPagamentoId(tpSelected);
        ...
        int CatId=0;
         ...
         try{
            ...
            PreparedStatement ps = bdconnection.connect.prepareStatement("select id from categorias where categoria = '" + this.cb_CategoriasDespesas.getSelectedItem() + "'");
        ...
        if(txt_NIF.getText().length()>1 && txt_valor.getText().length()>1 && cb_CategoriasDespesas.getSelectedIndex()>=0 && txt_data.getText().length()>1){
            ...
            createdesp.tipopagamentoId = tpId;
    ...
    private void btn_localActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_localActionPerformed
        ...
        try {
            ...
            String nporta = txt_nporta.getText();
    ...
    private void txt_nportaCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_txt_nportaCaretUpdate
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_nportaCaretUpdate

    private void txt_nportaFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txt_nportaFocusLost
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_nportaFocusLost
    ...
    private void txt_NIFKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_NIFKeyTyped
        
        if(txt_NIF.getText().length()==9) {  
            evt.consume();
         }
    }//GEN-LAST:event_txt_NIFKeyTyped
    ...
    private javax.swing.JTextField txt_nporta;
